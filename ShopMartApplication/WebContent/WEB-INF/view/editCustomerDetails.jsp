...
<form:form method="post" action="/ShopMartApplication/updateCustomerDetails" commandName="customer">
			<h3 class="text-success text-center">Edit Customer Details</h3>
			...
			<div class="top50 row">
				...
				<div class="col">
					<button type="button" class="btn btn-success"
						onclick="location.href='/../ShopMartApplication/deleteCustomer/${customer.customerId}'">Delete user</button>
				</div>
			</div>
